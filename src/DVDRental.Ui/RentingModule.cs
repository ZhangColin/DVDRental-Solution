...
{
    public class RentingModule: Module {
        protected override void Load(ContainerBuilder builder) {
            builder.RegisterType<RentingService>().As<RentingService>().SingleInstance();
            builder.RegisterType<SubscriptionService>().As<SubscriptionService>().SingleInstance();

            builder.RegisterType<RentingMapperProfile>().As<Profile>().SingleInstance();
